...
export default function OnboardingPage() {
  ...
  function finish() {
    // TODO: сохранить профиль в Supabase
    router.push("/day1");
  }
  ...
  if (step > TOTAL) {
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center bg-[var(--bg-primary)] px-7 text-center">
        ...
        <button
          onClick={finish}
          className="w-full max-w-xs h-[54px] bg-ink-primary text-canvas rounded-pill text-[15px] font-medium hover:bg-accent transition-colors"
        >
          Начать с НИКОЙ
        </button>
      </div>
