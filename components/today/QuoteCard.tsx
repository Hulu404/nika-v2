export function QuoteCard({ quote }: { quote: string }) {
  return (
    <div className="col-span-2 rounded-card bg-surface-nika px-6 py-5">
      <div className="flex gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="font-serif text-[19px] italic leading-[1.35] tracking-[-0.01em] text-ink-primary lg:text-[22px]">
            {quote}
          </p>
        </div>
      </div>
