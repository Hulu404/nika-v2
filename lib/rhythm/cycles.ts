...
export const PHASE_META: Record<Phase, {
  ...
  rise: {
    ...
    heroAfter: ".",
    lede: "Фаза подъёма. Силы возвращаются, восстановление быстрее обычного — лучшее время для интервалов, длинных дистанций и смелых целей.",
    labelRu: "Подъём",
  ...
  peak: {
    ...
    heroBefore: "Ты на ",
    heroAfter: " формы.",
    lede: "Овуляция. Сегодня тело способно на максимум — и просит внимательной разминки: связки сейчас эластичнее обычного, начни мягко.",
    labelRu: "Пик",
