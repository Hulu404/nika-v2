...
/**
 * @deprecated pure-push. Это банк вопросов ДВУСТОРОННЕГО чек-ина в боте
 * (вопрос + inline-кнопки состояний). Интерактивный чек-ин снят — на этот файл
 * больше не ссылается прод-код (только собственный тест). Новый пул формулировок
 * утреннего pure-push нуджа заводится ОТДЕЛЬНО в Промте 3, не здесь.
 * Оставлен до финальной чистки, не расширять.
 *
